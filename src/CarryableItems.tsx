...
const carryableItems: carryableItemsShape[] = [
  ...
  { itemComponent: <Flashlight />, legal: false , description: 'Flashlight'},
  { itemComponent: <Pill />, legal: false , description: 'Loose pills'},
  { itemComponent: <PillBottle />, legal: false , description: 'Prescription Pills'},
  { itemComponent: <Syringe />, legal: false , description: 'Syringe [empty]'},
  { itemComponent: <Cigarette />, legal: false , description: 'Cigarettes'},
